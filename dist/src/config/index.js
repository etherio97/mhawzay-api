...
exports.EMAIL_VALIDATION_PATTERN = exports.DATABASE_URL = exports.SUPABASE_SECRET = exports.SUPABASE_URL = exports.FIREBASE_PROJECT_ID = exports.PORT = void 0;
...
exports.EMAIL_VALIDATION_PATTERN = /^\w+@[a-z]+\.[a-z]{2,6}$/;
